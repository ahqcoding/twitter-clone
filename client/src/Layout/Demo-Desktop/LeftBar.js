    ...
    <div className="flex flex-col xl:w-1/5 border-r border-lighter px-2 lg:px-6 py-2 justify-between">
      <div className="w-full">
        ...
        {menus.map((menu, index) => (
          <div
            key={index}
            className="focus:outline-none hover:text-blue flex justify-start items-center xl:hover:bg-lightblue rounded-full mr-auto mb-3"
          >
            ...
            <p className="text-lg font-semibold text-left hidden xl:block">
              {menu.title}
            </p>
          </div>
        ))}
