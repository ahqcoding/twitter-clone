...
export default function App() {
  ...
  return (
    <div className="flex h-screen w-full h-full">
      <div
        className={` px-4 h-full w-11/12 min-w-11/12 transition-all duration-500 transform ${hideSidebar}`}
      >
        <div className="flex items-center border-b justify-between w-full hover:bg-lightblue">
          <h1 className="h-12 text-xl font-bold"> Account info </h1>
